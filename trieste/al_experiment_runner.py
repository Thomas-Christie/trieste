...
flags.DEFINE_boolean('conservative_penalty_decrease', True, 'Whether to reduce the penalty parameter more '
...
flags.DEFINE_string('save_path', 'results/final_ts_results/gsbp/adam_no_prev_rbf_conservative/data/run_',
