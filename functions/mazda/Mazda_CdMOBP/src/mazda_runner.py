...
def mazda_observer(query_points: TensorType) -> Mapping[Tag, Dataset]:
    ...
    # e.g. "trieste/functions/mazda/Mazda_CdMOBP/src/"
    # Refer to the README for instructions on how to obtain the Mazda executable
    MAZDA_EXECUTABLE_DIR = ""
    if MAZDA_EXECUTABLE_DIR == "":
        raise ValueError("MAZDA_EXECUTABLE_DIR must be set to the directory containing the Mazda problem executable")
    os.chdir(MAZDA_EXECUTABLE_DIR)
